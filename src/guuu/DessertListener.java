...
public class DessertListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			PrintWriter outFile=new PrintWriter (bw);
				...
				outFile.write("cake\n");
				outFile.write("pudding\n");
				outFile.write("cookie\n");
				outFile.write("apple pie\n");
				outFile.write("chocolate\n");
				outFile.write("baklava\n");
	...
	p2.add(new JTextField("Desserts"),BorderLayout.NORTH);
