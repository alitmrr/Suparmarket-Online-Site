...
public class Sebzelistener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				PrintWriter outFile=new PrintWriter (bw);
					...
					outFile.write("Pea\n");
					outFile.write("Beans\n");
					outFile.write("Spinach\n");
					outFile.write("Garlic\n");
					outFile.write("Gorn\n");
					outFile.write("Tomato");
			...
			try {
				...
				p2.add(new  JTextField("Vegetables"),BorderLayout.NORTH);
