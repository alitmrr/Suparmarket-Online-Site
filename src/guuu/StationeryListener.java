...
public class StationeryListener implements ActionListener {
	JFrame histogramFrame1= new JFrame();



	public void actionPerformed(ActionEvent e) {
		String file1 = "stionery.txt";
		try {
			...
			PrintWriter outFile=new PrintWriter (bw);
				...
				outFile.write("eraser\n");
				outFile.write("pencil\n");
				outFile.write("glue\n");
				outFile.write("ruler\n");
				outFile.write("scissors\n");
				outFile.write("notebook\n");
		...
		try {
			...
			p2.add(new JTextField("Stionery"),BorderLayout.NORTH);
